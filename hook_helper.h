...
#ifndef GROUNDED_MINIMAP_HOOK_HELPER_H
#define GROUNDED_MINIMAP_HOOK_HELPER_H
...
private:
    ...
    static ID3D12CommandQueue** ppCommandQueue_;
...
#endif //GROUNDED_MINIMAP_HOOK_HELPER_H
